...
export class CodeComponent {
  ...
  topics = [
    ...
    {id:5, value:'Directivas estructurales y atributivas', description: 'Las directivas en Angular son una característica fundamental que permite manipular el DOM (Document Object Model) de forma declarativa.'},
    {id:6, value:'Debugging en Angular', description: 'Debugging en Angular se refiere al proceso de identificar y corregir errores en tu aplicación. Angular, como framework, ofrece varias herramientas y enfoques que facilitan la depuración durante el desarrollo.'},
    {id:7, value:'Retos en angular (Material audiovisual)', description: 'En esta sección encontraremos ejercicios y desafios para practicar y mejorar tus conocimientos sobre Angular, utilizando todos los conceptos anteriores.'},
  ]
